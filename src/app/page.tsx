  ...
  return (
    <>
      <div className="bg-gray-900 px-4 py-12 lg:p-36 md:p-24 text-orange-400 text-">
        ...
        <div className="md:flex grid md:w-3/4 mx-auto">
          <div className="md:w-1/2 md:order-2 text-2xl order-2">
          ...
          <div className="text-left md:w-1/2 md:order-1 order-1 pb-28 md:pb-8">
            <div className="w-full m-auto -mt-10">
              {tags.map((tag) => (
                <div key={tag.id} className="relative py-5 text-3xl">
                  ...
                  <div className="absolute bottom-0  md:w-2/4 w-3/4 h-0.5 bg-orange-400"></div>
                </div>
              ))}
            </div>
          </div>
